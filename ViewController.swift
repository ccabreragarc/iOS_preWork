...
class ViewController: UIViewController {
    ...
    @IBAction func introduceSelfDidTapped(_ sender: UIButton) {
        ...
        let introduction = "My name is \(firstName.text!) \(lastName.text!) and I attend \(schoolName.text!). I am currently in my \(year!) year and I own \(petsCount.text!) dogs. It is \(morePetsSwitch.isOn) that I want more pets."
